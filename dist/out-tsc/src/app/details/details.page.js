...
var DetailsPage = /** @class */ (function () {
    function DetailsPage(api, route, navCtrl, DbFavorisService) {
        this.api = api;
        this.route = route;
    ...
    DetailsPage.prototype.getInfos = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.api.getDetails(this.id)
                            .subscribe(function (res) {
                            //console.log(res);
                            _this.details = res;
                            for (var i = 1; i <= parseInt(_this.details.totalSeasons); i++) {
                                _this.nbSeason.push(i);
                            }
                        }, function (err) {
                            console.log(err);
                        })];
    ...
    DetailsPage.prototype.envoisDetailSeason = function (Season) {
        this.navCtrl.navigate("details/" + this.id + "/season/" + Season, {});
    };
    DetailsPage.prototype.toggleFavorite = function () {
